...
echo "Your Company unique ID is: " .$POST['id']. "<br>"
...
$sql = "Insert into company (CompanyName,Address,Balance,CreditLimit)
VALUES ('$_POST[company]','$_POST[address]','$_POST[balance]','$_POST[credit]')";
