<!--
•	Name of screen: Returns.html.php  
•	Purpose of screen: This is the form which allows a user to return a car from rentals
...
•	connects to myStyle.css
•	|Student name:Abigail Murray|Student Number:C00260073|Date:March/April  2024|
-->

<?php session_start(); // initialise a session and allows you to store and retrieve session variables
?>
        ...
        <div class="returnCar">
            ...
            <script>
                ...
                function confirmCheck() {
                    ...
                    if (sel.selectedIndex === -1) {
                        alert("There has been no car selected.Please select a car from the list before submitting.");
                        return false;
                    }
            ...
            <form name="returnForm" action="ReturnCar.php" onsubmit="return confirmCheck()" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="registration" id="registration" disabled required>
                </div>

                <div class="form-group">
                    <label for="modelName">Model Name</label>
                    <input type="text" id="modelName" name="modelName" disabled required>
                </div>

                <div class="form-group">
                    <label for="version">Version</label>
                    <input type="text" id="version" name="version" disabled required>
                </div>

                <div class="form-group">
                    <label for="engineSize">Engine Size</label>
                    <input type="text" id="engineSize" name="engineSize" disabled required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="dueReturnDate" id="dueReturnDate" disabled required>
                </div>
                ...
                <div class="button-group">
                    ...
                    <button
                        type="reset">Reset</button><!-- adding in reset option if user woudld like to reset the fields-->
                </div>
